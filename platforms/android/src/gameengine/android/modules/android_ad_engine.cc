...
AndroidAdEngine::AndroidAdEngine(JNIEnv *jni_env, jobject java_object)
    : jni_env_(jni_env) {
...
AndroidAdEngine::~AndroidAdEngine() {
...
void AndroidAdEngine::SetPublisherId(std::string publisher_id) {
